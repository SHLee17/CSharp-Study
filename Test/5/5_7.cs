...
namespace Test._5
{
    internal class _5_7
    {
        ...
        public static void Game()
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if (!words.Contains(youWord))
                        throw new Exception("가위, 바위, 보 중에 하나만 내세요.");
                }
                catch (Exception e)
                {
            ...
            Console.WriteLine("가위, 바위, 보 입력 : " + comWord);

            if (comWord == "가위" && youWord == "가위") Console.WriteLine("무승부");
            else if (comWord == "가위" && youWord == "바위") Console.WriteLine("당신의 승리");
            else if (comWord == "가위" && youWord == "보") Console.WriteLine("컴퓨터 승리");
            else if (comWord == "바위" && youWord == "가위") Console.WriteLine("컴퓨터 승리");
            ...
            else if (comWord == "보" && youWord == "바위") Console.WriteLine("컴퓨터 승리");
